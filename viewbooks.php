        ...
        <?php
          ...
          while($row = mysqli_fetch_assoc($query_run)){
            ...
            <tr>
              ...
              <td>
                 <a href="editbook.php?bn=<?php echo $row['ID'];?>" class="btn btn-primary btn-md">Edit</a>
                 <a href="deletebook.php?bn=<?php echo $row['ID'];?>" class="btn btn-danger btn-md">Delete</a>
              </td>
            </tr>
            <?php
          }
